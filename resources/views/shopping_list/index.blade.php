@extends('layouts.app')
@section('PageTitle', 'Shopping Lists')
@section('content')
<section id="content">
        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-2 d-none d-md-block"><button class="btn btn-sm btn-primary me-2" data-bs-toggle="modal" data-bs-target=".addModal">Add New Shopping List</button></div>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="mb-1">
                                    <input class="form-control form-control-sm" type="text" name="name[]"
                                        placeholder="Shopping List Name" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-1">
